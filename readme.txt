...
Ans. Yes, you can request a specific feature by creating Feature Request. The implementation of that feature will be based on how many users are asking for that feature and that feature will not invite any future conflict or security issues.

Q7. Where to report bugs (if any) in the Theme?
Ans. You can create issues in this repository by clicking on Create Bugs
